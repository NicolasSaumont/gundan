...
<template>
  <div class="w-[50%] h-[5%] absolute top-[15%] left-[5%]">
    ...
    <div class="absolute left-[5%] top-[50%] transform -translate-y-1/2 flex gap-2 z-20">
      <CollectionListSelectedCardModalCardExperienceStars :count="currentLevel" imageSrc="_nuxt/assets/images/cards/elements/star.png" />
      <CollectionListSelectedCardModalCardExperienceStars :count="differenceFromCurrentToMaxLevel" imageSrc="_nuxt/assets/images/cards/elements/star-black-white.png" />
    </div>
  </div>
</template>
